                    ...
                    if ($response->successful()) {
                       return $responseData = $response->json();
                        ...
                        if ($responseData['numAdded'] > 0) {
                            // $predictionResponse = Http::post('https://ai.recruitangle.com/api/v1/prediction/0ca3249e-6746-4b8c-a90b-6dc3952ef064', [
                            //     'question' => 'give me the analysis of the CV, the person wants to become a '.$request->job_title
                            // ]);
                            $maxRetries = 5;
